...
public class Us extends Rs {
  ...
  public Us(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, ArrayList<BlockBean> paramArrayList) {
  ...
  private TextView createLabel(String paramString) {
    ...
    if (str1 != null) {
      ...
      if (str1.length() > 0) {
        ...
        stringBuilder.append(((Ts)this).c);
    ...
    RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, ((Ts)this).G);
...
/* Location:              C:\Users\Administrator\IdeaProjects\Sketchware-Pro\app\libs\a.a.a-notimportant-classes.jar!\a\a\a\Us.class
