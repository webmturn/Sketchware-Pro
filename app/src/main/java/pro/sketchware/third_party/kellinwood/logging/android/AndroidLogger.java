...
import pro.sketchware.third_party.kellinwood.logging.DefaultLogger;
...
public class AndroidLogger extends DefaultLogger
{
	...
	// E.g., A parameter value of pro.sketchware.third_party.kellinwood.zipsigner.ZipPickerActivity results in a tag value of "ZipPickerActivity".
