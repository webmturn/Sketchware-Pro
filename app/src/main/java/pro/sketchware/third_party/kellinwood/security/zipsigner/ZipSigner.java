...
import pro.sketchware.third_party.kellinwood.zipio.ZioEntry;
import pro.sketchware.third_party.kellinwood.zipio.ZipInput;
import pro.sketchware.third_party.kellinwood.zipio.ZipOutput;
        ...
        throws IOException, GeneralSecurityException
    {
        if (keySet.getSigBlockTemplate() != null) {
            ...
            try {
                ...
                Class generatorClass = Class.forName("pro.sketchware.third_party.kellinwood.security.zipsigner.optional.SignatureBlockGenerator");
