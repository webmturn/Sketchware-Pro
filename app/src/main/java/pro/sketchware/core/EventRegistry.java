...
public class EventRegistry {
    ...
    public static String[] getComponentEventsForClass(ClassInfo classInfo) {
        ...
        if (classInfo.matchesType("Gyroscope")) {
            eventList.add("onSensorChanged");
        }

        if (classInfo.matchesType("InterstitialAd")) {
        ...
        if (classInfo.matchesType("FirebaseStorage")) {
    ...
    public static String[] getListenersForClass(ClassInfo classInfo) {
        ArrayList<String> eventList = new ArrayList<>();
        ...
        if (classInfo.matchesType("WebView")) {
            eventList.add("webViewClient");
        }

        if (classInfo.matchesType("CalendarView")) {
            eventList.add("onDateChangeListener");
        }

        if (classInfo.matchesType("MapView")) {
        ...
        if (classInfo.matchesType("AdView")) {
    ...
    public static String[] getEventsForClass(ClassInfo classInfo) {
        ArrayList<String> eventList = new ArrayList<>();
