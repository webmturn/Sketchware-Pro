...
public class BlockSpecRegistry {
    ...
    private static void initBlockParams() {
        ...
        BLOCK_PARAMS.put("googleSignInInit", new String[]{"%m.googlelogin", "%s"});
        BLOCK_PARAMS.put("googleSignInLaunch", new String[]{"%m.googlelogin"});
        BLOCK_PARAMS.put("googleSignOut", new String[]{"%m.googlelogin"});
        BLOCK_PARAMS.put("phoneAuthSendCode", new String[]{"%m.phoneauth", "%s"});
        BLOCK_PARAMS.put("phoneAuthResendCode", new String[]{"%m.phoneauth", "%s"});
        BLOCK_PARAMS.put("phoneAuthSignIn", new String[]{"%m.firebaseauth", "%s", "%s"});
        BLOCK_PARAMS.put("fcmGetToken", new String[]{"%m.cloudmessage"});
        BLOCK_PARAMS.put("fcmSubscribeTopic", new String[]{"%m.cloudmessage", "%s"});
        BLOCK_PARAMS.put("fcmUnsubscribeTopic", new String[]{"%m.cloudmessage", "%s"});
    ...
    private static void initBlockSpecs() {
        ...
        BLOCK_SPECS.put("googleSignInInit", "google_sign_in_init");
        BLOCK_SPECS.put("googleSignInLaunch", "google_sign_in_launch");
        BLOCK_SPECS.put("googleSignOut", "google_sign_out");
        BLOCK_SPECS.put("phoneAuthSendCode", "phone_auth_send_code");
        BLOCK_SPECS.put("phoneAuthResendCode", "phone_auth_resend_code");
        BLOCK_SPECS.put("phoneAuthSignIn", "phone_auth_sign_in");
        BLOCK_SPECS.put("fcmGetToken", "fcm_get_token");
        BLOCK_SPECS.put("fcmSubscribeTopic", "fcm_subscribe_topic");
        BLOCK_SPECS.put("fcmUnsubscribeTopic", "fcm_unsubscribe_topic");
