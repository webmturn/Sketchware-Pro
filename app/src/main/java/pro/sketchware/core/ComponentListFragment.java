...
public class ComponentListFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (!UIHelper.isClickThrottled() && v.getId() == binding.fab.getId()) {
                        ...
                        if (availableEvents.contains(event.eventName)) {
                            ...
                            LinearLayout.LayoutParams layoutParams =
                                    new LinearLayout.LayoutParams(
                                            ViewGroup.LayoutParams.WRAP_CONTENT,
                                            ViewGroup.LayoutParams.WRAP_CONTENT);
                            layoutParams.setMargins(0, 0, (int) ViewUtil.dpToPx(requireContext(), 4.0f), 0);
                    ...
                    for (String eventName : availableEvents) {
                        ...
                        LinearLayout.LayoutParams layoutParams2 =
                                new LinearLayout.LayoutParams(
                                        ViewGroup.LayoutParams.WRAP_CONTENT,
                                        ViewGroup.LayoutParams.WRAP_CONTENT);
                        layoutParams2.setMargins(0, 0, (int) ViewUtil.dpToPx(requireContext(), 4.0f), 0);
