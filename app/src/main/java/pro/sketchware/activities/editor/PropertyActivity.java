...
import pro.sketchware.activities.editor.property.UserExperienceLevel;
...
public class PropertyActivity extends BaseAppCompatActivity implements PropertyChangedCallback {
    ...
    public void saveAndFinish() {
        ...
        if (this.viewBean.id.equals("_fab")) {
            ...
            viewBean = ProjectDataManager.getProjectDataManager(sc_id).getViewBean(projectFileBean.getXmlName(), this.viewBean.preId);
        }
