...
public class CustomViewFilesFragment extends BaseFragment {
  ...
  public class FileListAdapter extends RecyclerView.Adapter<FileListAdapter.ViewHolder> {
    ...
    public final CustomViewFilesFragment outerAdapter;
    
    public FileListAdapter(CustomViewFilesFragment this$0, RecyclerView recyclerView) {
      outerAdapter = this$0;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
      ...
      public final CustomViewFilesFragment.FileListAdapter adapterRef;
      
      public ViewHolder(CustomViewFilesFragment.FileListAdapter this$0, View itemView) {
        super(itemView);
        adapterRef = this$0;
