...
import pro.sketchware.project.CustomBlocksDialog;
import pro.sketchware.project.ManageProguardActivity;
import pro.sketchware.project.ProguardHandler;
import pro.sketchware.project.ManageStringFogFragment;
    ...
    private static class BuildTask extends BaseTask implements BuildProgressReceiver {
        ...
        public void onProgress(String progress, int step) {
            ...
            postToUi(activity, () -> {
                ...
                if (step >= 1) {
                    stepInfoText.setText(step + "/" + totalSteps + " Â· " + elapsedStr);
                } else {
