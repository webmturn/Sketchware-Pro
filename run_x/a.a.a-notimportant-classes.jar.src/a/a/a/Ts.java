...
public class Ts extends RelativeLayout {
  ...
  public Ts(Context paramContext, String paramString1, String paramString2, boolean paramBoolean) {
    super(paramContext);
    this.h = 3;
    this.i = 12;
    this.j = 15;
  ...
  public Ts(Context paramContext, String paramString, boolean paramBoolean) {
  ...
  public void a(Ts paramTs, boolean paramBoolean1, boolean paramBoolean2, int paramInt) {
    this.e = -16777216;
    this.d = paramTs.d;
    this.z = paramTs.z;
    this.A = paramTs.A;
...
/* Location:              C:\Users\Administrator\IdeaProjects\Sketchware-Pro\app\libs\a.a.a-notimportant-classes.jar!\a\a\a\Ts.class
