...
**已有：** 调色板类别搜索（PaletteSelector.showSearchDialog）、块级搜索（调色板 blockSearchField + 画布 canvasSearchInput）
...
2. ~~**块级搜索**~~ ✅ 已完成 — 调色板类别搜索 + 画布 canvasSearchInput 均已实现
